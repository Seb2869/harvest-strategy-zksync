...
const Strategy = "VelocoreStrategyMainnet_ETH_USDCe";

// Developed and tested at blockNumber 33964350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Velocore ETH-USDC.e", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x42D106c4A1d0Bc5C482c11853A3868d807A3781d");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"zkSwap": [vc, weth]}, {"zkSwap": [vc, weth, usdce]}]
    });
  });
