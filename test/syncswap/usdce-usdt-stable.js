...
const Strategy = "SyncSwapStrategyMainnet_USDCe_USDT_stable";

// Developed and tested at blockNumber 46044281

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap USDC.e-USDT", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x0E595bfcAfb552F83E25d24e8a383F88c1Ab48A4");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"zkSwap": [zk, weth]}, {"zkSwap": [zk, weth, usdce]}]
    });
  });
