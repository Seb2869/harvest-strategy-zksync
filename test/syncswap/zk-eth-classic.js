...
const Strategy = "SyncSwapStrategyMainnet_ZK_ETH_classic";

// Developed and tested at blockNumber 53580900

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap ZK-ETH", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x45856bD6Bb9f076F4C558A4D5932c6c8d832b0d0");
