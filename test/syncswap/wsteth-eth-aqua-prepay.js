...
const Strategy = "SyncSwapStrategyMainnet_wstETH_ETH_aqua";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap wstETH-ETH - PrePay", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x12e7A9423d9128287E63017eE6d1f20e1C237f15");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0x256bc71d47E5420d4089204a6f6257425e285E66",
