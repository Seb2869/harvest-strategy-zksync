...
const Strategy = "SyncSwapStrategyMainnet_USDC_USDCe_stable";

// Developed and tested at blockNumber 53580900

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap USDC-USDCe", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0xA93472C1B88243793E145B237b7172F1EE547836");
