...
const Strategy = "SyncSwapStrategyMainnet_ETH_USDCe_classic";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap ETH-USDC.e - PrePay", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x80115c708E12eDd42E504c1cD52Aea96C547c05c");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0xd0d159b4814B30b0E2750eF61D32307D0B3d4bA8",
