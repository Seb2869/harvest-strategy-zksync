...
const Strategy = "SyncSwapStrategyMainnet_MBTC_WBTC_stable";

// Developed and tested at blockNumber 53580900

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet SyncSwap MBTC-WBTC", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x57B11C2C0Cdc81517662698A48473938e81d5834");
