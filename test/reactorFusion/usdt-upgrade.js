...
const Strategy = "ReactorFusionFoldStrategyMainnet_USDT";

// Developed and tested at blockNumber 53801130

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet ReactorFusion USDT - upgrade", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x493257fD37EDB34451f62EDf8D2a0C418852bA4C");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0x061366ac9867f30e4693e76394f214BFaBA04374",
