...
const Strategy = "ReactorFusionFoldStrategyMainnet_USDC";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Reactor USDC - PrePay reward", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0x1d17CBcF0D6D143135aE902365D2E5e2A16538D4");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0x5837445312f5D8A77a5cFa4A28801D3EEF47bE8B",
