...
// Developed and tested at blockNumber 43457815

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet ReactorFusion ZK", function() {
  let gasPrice;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"zkSwap": [rf, weth, "0x5A7d6b2F92C77FAD6CCaBd7EE0624E64907Eaf3E"]}]
    });
  });
