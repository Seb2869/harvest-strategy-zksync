...
const Strategy = "VenusFoldStrategyMainnet_WUSDM";

// Developed and tested at blockNumber 55184350

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Venus WUSDM", function() {
  let gasPrice;
  ...
  async function setupExternalContracts() {
    underlying = await zksyncEthers.getContractAt("IERC20", "0xA900cbE7739c96D2B153a273953620A701d5442b");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [weth, "0xA900cbE7739c96D2B153a273953620A701d5442b"]},
        {"uniV3": ["0xA900cbE7739c96D2B153a273953620A701d5442b", weth]},
      ]
    });
