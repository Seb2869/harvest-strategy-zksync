...
const Strategy = "VenusFoldStrategyMainnet_WBTC";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Venus WBTC - PrePay reward", function() {
  let gasPrice;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0xA79ccaf161f263AE1f2ba595c2239377E317Bd6B",
