...
const Strategy = "VenusFoldStrategyMainnet_USDCe";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Venus USDC.e - PrePay reward", function() {
  let gasPrice;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0x6047987B668804506133887DB55eEb0A709C73c4",
