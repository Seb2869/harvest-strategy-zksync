...
const Strategy = "VenusFoldStrategyMainnet_USDC";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Venus USDC - PrePay reward", function() {
  let gasPrice;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0xe5c4F0644E15d0e480d8D38aC97485f8aF9D9781",
