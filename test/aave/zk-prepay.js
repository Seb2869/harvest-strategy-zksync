...
const Strategy = "AaveFoldStrategyMainnet_ZK";

// Developed and tested at blockNumber 55464000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ZKSync Mainnet Aave ZK - PrePay reward", function() {
  let gasPrice;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "gasPrice": gasPrice,
      "existingVaultAddress": "0x676a8BcF8ACBaB1a38e53dB83C74a4b1A53bf782",
